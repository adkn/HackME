...
class Boot(Tkinter.Label):
	def __init__(self, mWindow, width, height, bgcolor, bootTime=5, shutTime=2):
		...
		self.config(font=("courier",  8, "normal"), width=self.lw, height=self.th)
